...
var passwordCheckOld = function () 
{
    ...
    stringOutput = "";
 //makes sure the length is right
  /* insert code
   * here
   */
  var intCount= stringPassword.length;
  if (intCount< 8 ) {
   stringOutput= "password needs to be more than 8 characters";
  ...
  if (stringOutput!= "this is a bad password" && stringOutput!="password needs to be more than 8 characters") {
    stringOutput= "this is a good password";
  }
  $("output").value= stringOutput;
};
//push solution thru Dom
