...
intMin= parseInt(prompt("Choose the lower number in range. It must be at least zero"));
...
*/
intMax= parseInt(prompt("Choose the higher number in range. It must be two more than the minimum."));
